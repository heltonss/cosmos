...
"use strict";var alunoFormControllers=angular.module("alunoFormControllers",[]);alunoFormControllers.controller("alunoFormCtrl",["crudAluno","$routeParams",function(o,n){function r(n){var r=r;o.delete({id:r},function(o){location.reload()},function(o){console.log("exclusão deu errado"+JSON.stringify(o))})}function t(r){var t=(n.id,JSON.stringify(r));o.update(t,function(o){console.log("Atualização ocorreu corretamente.")},function(o){console.log("Atualização Falhou")})}function e(n){var n=new Aluno(n.nome.trim(),n.sobrenome.trim(),n.dataNascimento.trim(),n.naturalidade.trim(),n.sexo.trim(),n.foto.trim(),n.nota.trim(),n.matricula.trim(),n.endereco.trim(),n.contato.trim()),r=JSON.stringify(n,null," ");o.save(r,function(o){console.log("colaborador salvo no banco")}),function(o){console.log("erro"+JSON.stringify(o))}}var l=this;l.exclude=r,l.update=t,l.create=e}]);
...
"use strict";var professorFormControllers=angular.module("professorFormControllers",[]);professorFormControllers.controller("professorFormCtrl",[function(){}]);
