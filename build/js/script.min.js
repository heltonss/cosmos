...
"use strict";var appCosmos=angular.module("appCosmos",["ngRoute","sessionControllers","colaboradorFormControllers","alunoFormControllers","professorFormControllers","diretorFormControllers"]);appCosmos.config(["$routeProvider","$locationProvider",function(r,o){r.when("/",{templateUrl:"partials/user_sessions/login.html",controller:"sessionCtrl"}).when("/dashboard",{templateUrl:"partials/dashboard/dashboard.html"}).when("/cadastro-colaborador",{templateUrl:"partials/colaborator-form/colaborator-form.html",controller:"colaboradorFormCtrl"}).when("/cadastro-diretor",{templateUrl:"partials/diretor-form/diretor-form.html",controller:"diretorFormCtrl"}).when("/cadastro-professor",{templateUrl:"partials/professor-form/professor-form.html",controller:"professorFormCtrl"}).when("/cadastro-aluno",{templateUrl:"partials/aluno-form/aluno-form.html",controller:"alunoFormCtrl"}),o.html5Mode(!1)}]);
