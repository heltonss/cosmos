...
"use strict";var dashCursoControllers=angular.module("dashCursoControllers",[]);dashCursoControllers.controller("dashCursoCtrl",["$routeParams","crudCurso","listarProfessores","listarAlunosService","crudSemestre","listarSemestre",function(e,o,r,n,s,t){function i(e){var o=new Semestre;o.ano=e.ano,o.curso=f.curso.nome,o.semestre=e.semestre.semestre,o.disciplina=f.disciplina,o.professor=e.professor.nome,o.alunosMatriculados=m;var r=JSON.stringify(o,null," ");console.log(r),s.save(r,function(e){console.log("semestre salvo")},function(e){console.log("error",e)})}function c(e){return m.push({nome:e,notas:[]})}function l(e){return m=m.filter(function(o){return o.nome!==e})}function u(){for(var e=document.getElementsByTagName("input"),o=e.length,r=0;r<o;r++)"checkbox"==e[r].type&&e[r].checked&&(f.disciplina=e[r].value)}function a(){for(var e=document.getElementsByTagName("input"),o=e.length,r=0;r<o;r++)"checkbox"!=e[r].type||e[r].checked||(f.disciplina="")}var f=this,g=e.id;f.createSemestre=i,f.addAluno=c,f.removeAluno=l,f.addDisciplina=u,f.removeDisciplina=a;var m=[];o.get({id:g},function(e){f.curso=e},function(e){console.log("error: ",JSON.stringify(e))}),r.get({},function(e){f.professores=e},function(e){console.log("error",JSON.stringify(e))}),n.get({},function(e){f.alunos=e},function(e){console.log("error",JSON.stringify(e))}),t.get({},function(e){f.listarSemestre=e,console.log(e)},function(e){console.log("error",JSON.stringify(e))}),s.get({id:g},function(e){f.semestre=e},function(e){console.log("error",JSON.stringify(e))})}]);
