...
var mediaAlunoFilter=angular.module("mediaAlunoFilter",[]);mediaAlunoFilter.filter("mediaNotas",function(){return function(e){var r=e.length;if(r){var n=e.reduce(function(e,r){return e+r});return media=n/r}return total=""}});
...
"use strict";var dashCursoControllers=angular.module("dashCursoControllers",[]);dashCursoControllers.controller("dashCursoCtrl",["$routeParams","crudCurso","listarProfessores","listarAlunosService","crudSemestre","listarSemestre",function(e,o,r,n,s,t){function i(e){var o=new Semestre;o.ano=e.ano,o.curso=f.curso.nome,o.semestre=e.semestre.semestre,o.disciplina=f.disciplina,o.professor=e.professor.nome,o.alunosMatriculados=m;var r=JSON.stringify(o,null," ");console.log(r),s.save(r,function(e){console.log("semestre salvo")},function(e){console.log("error",e)})}function c(){for(var e=document.getElementsByTagName("input"),o=e.length,r=0;r<o;r++)"checkbox"==e[r].type&&e[r].checked&&(f.disciplina=e[r].value)}function l(){for(var e=document.getElementsByTagName("input"),o=e.length,r=0;r<o;r++)"checkbox"!=e[r].type||e[r].checked||(f.disciplina="")}function u(e){return m.push({nome:e,notas:[]})}function a(e){return m=m.filter(function(o){return o.nome!==e})}var f=this,g=e.id;f.createSemestre=i,f.addAluno=u,f.removeAluno=a,f.addDisciplina=c,f.removeDisciplina=l;var m=[];o.get({id:g},function(e){f.curso=e},function(e){console.log("error: ",JSON.stringify(e))}),r.get({},function(e){f.professores=e},function(e){console.log("error",JSON.stringify(e))}),n.get({},function(e){f.alunos=e},function(e){console.log("error",JSON.stringify(e))}),t.get({},function(e){f.listarSemestre=e},function(e){console.log("error",JSON.stringify(e))})}]);
...
var gestaoDisciplinaControllers=angular.module("gestaoDisciplinaControllers",[]);gestaoDisciplinaControllers.controller("gestaoDisciplinaCtrl",["$routeParams","crudSemestre","listarSemestre","gestaoDisciplina",function(o,n,a,l){function r(o,i){e.nome=i,e.id=o}function s(){var o=c.alunosMatriculados.length;for(i=0;i<o;i++){var a=c.alunosMatriculados[i].notas;e.nome==c.alunosMatriculados[i].nome&&(a.push(e.nota),console.log("object",c))}console.log(JSON.stringify(c,null," ")),n.update({id:t},c,function(){console.log("salvou")},function(o){console.log("error ",o)})}var e=this,t=o.id;e.inserirNota=s,e.recuperarAluno=r;var c=n.get({id:t},function(o){e.disciplina=o,e.mediaGeral=l.calcMedia(e.disciplina.alunosMatriculados)},function(o){console.log("error ",o)})}]);
...
"use strict";var disciplinaService=angular.module("disciplinaService",[]);disciplinaService.service("gestaoDisciplina",function(){this.calcMedia=function(e){for(var i=e.length,n=[],r=0;r<i;r++){var c=e[r],t=c.notas;if(t.length<1)return"";var a=t.length,u=t.reduce(function(e,i){return e+i}),l=u/a;n.push(l)}var s=n.length,v=n.reduce(function(e,i){return e+i});return v/s}});
