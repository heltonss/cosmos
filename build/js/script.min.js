...
"use strict";var loginControllers=angular.module("loginControllers",[]);loginControllers.controller("loginCtrl",["$scope",function(o){function l(){console.log("teste")}var n=this;console.log("loginCtrl"),o.title="helton souza",n.loginValidate=l}]);
"use strict";var appCosmos=angular.module("appCosmos",["ngRoute","loginControllers"]);appCosmos.config(["$routeProvider","$locationProvider",function(o,e){o.when("/",{templateUrl:"partials/user_sessions/login.html",controller:"loginCtrl"}),e.html5Mode({enabled:!0,requireBase:!1}).hashPrefix("!")}]);