...
"use strict";function Semestre(s,i,t,e,a){this.ano=s,this.curso=i,this.semestre=t,this.disciplina=e,this.alunosMatriculados=a}
...
"use strict";var dashCursoControllers=angular.module("dashCursoControllers",[]);dashCursoControllers.controller("dashCursoCtrl",["$routeParams","crudCurso","listarProfessores","listarAlunosService","crudSemestre",function(e,o,r,n,s){function t(e){var o=new Semestre;o.ano=e.ano,o.curso=a.curso.nome,o.semestre=e.semestre.semestre,o.disciplina=a.disciplina,o.professor=e.professor.nome,o.alunosMatriculados=d;var r=JSON.stringify(o,null," ");console.log(r),s.save(r,function(e){console.log("semestre salvo")},function(e){console.log("error",e)})}function i(e){return d.push({nome:e,notas:[]})}function c(e){return d=d.filter(function(o){return o.nome!==e})}function l(){for(var e=document.getElementsByTagName("input"),o=e.length,r=0;r<o;r++)"checkbox"==e[r].type&&e[r].checked&&(a.disciplina=e[r].value)}function u(){for(var e=document.getElementsByTagName("input"),o=e.length,r=0;r<o;r++)"checkbox"!=e[r].type||e[r].checked||(a.disciplina="")}var a=this,f=e.id;a.createSemestre=t,a.addAluno=i,a.removeAluno=c,a.addDisciplina=l,a.removeDisciplina=u;var d=[];o.get({id:f},function(e){a.curso=e},function(e){console.log("error: ",JSON.stringify(e))}),r.get({},function(e){a.professores=e},function(e){console.log("error",JSON.stringify(e))}),n.get({},function(e){a.alunos=e},function(e){console.log("error",JSON.stringify(e))})}]);
...
"use strict";var listarAlunosControllers=angular.module("listarAlunosControllers",[]);listarAlunosControllers.controller("listarAlunosCtrl",["crudAluno","listarAlunosService",function(l,o){var r=this;o.get({},function(l){r.listarAlunos=l,console.log(l)},function(l){console.log("error",JSON.stringify(l))})}]);
