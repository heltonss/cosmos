...
"use strict";function Aluno(t,i,s,o,a,e,h,n,c,r){this.nome=t,this.sobrenome=i,this.dataNascimento=s,this.naturalidade=o,this.sexo=a,this.foto=e,this.nota=h,this.matricula=n,this.endereco=c,this.contato=r}
...
"use strict";function Semestre(s,t,e){this.curso=s,this.semestre=t,this.materias=e}
"use strict";function Suporte(){this.getMaterias=function(t){for(var i=[],r=0;r<t.length;r++)i[r]=t[r].tag;return this.chips=i}}
"use strict";var alunoFormControllers=angular.module("alunoFormControllers",[]);alunoFormControllers.controller("alunoFormCtrl",["crudAluno","$routeParams",function(o,n){function a(n){var a=a;o.delete({id:a},function(o){location.reload()},function(o){console.log("exclusão deu errado"+JSON.stringify(o))})}function e(a){var e=(n.id,JSON.stringify(a));o.update(e,function(o){console.log("Atualização ocorreu corretamente.")},function(o){console.log("Atualização Falhou")})}function r(n){var a=new Aluno;a.nome=i.sanitizer(n.nome),a.sobrenome=i.sanitizer(n.sobrenome),a.dataNascimento=i.sanitizer(n.dataNascimento),a.naturalidade=i.sanitizer(n.naturalidade),a.sexo=i.sanitizer(n.sexo),a.foto=n.foto,a.nota=n.nota,a.matricula=i.sanitizer(n.matricula),a.endereco=i.sanitizer(n.endereco),a.contato=i.sanitizer(n.contato);var e=JSON.stringify(a,null," ");o.save(e,function(o){console.log("colaborador salvo no banco")},function(o){console.log("erro"+JSON.stringify(o))})}var t=this,i=new Sanitizer;t.exclude=a,t.update=e,t.create=r}]);
...
"use strict";var dashCursoControllers=angular.module("dashCursoControllers",[]);dashCursoControllers.controller("dashCursoCtrl",["$routeParams","crudCurso","listarProfessores",function(r,o,s){var n=this,t=r.id;o.get({id:t},function(r){n.curso=r},function(r){console.log("error: ",JSON.stringify(r))}),s.get({},function(r){n.professores=r},function(r){console.log("error",JSON.stringify(r))})}]);
...
"use strict";var alunoService=angular.module("alunoService",["ngResource"]);alunoService.factory("crudAluno",["$resource",function(r){var e="http://localhost:5000/";return r("",{},{get:{method:"GET",url:e+"aluno/:id",cache:!1,isArray:!1},save:{method:"POST",url:e+"aluno",cache:!1,isArray:!1},update:{method:"PUT",url:e+"aluno/:id",cache:!1,isArray:!1},delete:{method:"DELETE",url:e+"aluno/:id",cache:!1,isArray:!1}})}]),alunoService.factory("listAlunos",["$resource",function(r){return r(urlEndPoint.toString(),{},{get:{method:"GET",cache:!1,isArray:!0}})}]);
...
"use strict";var cursoService=angular.module("cursoService",["ngResource"]),urlEndPoint="http://localhost:5000/";cursoService.factory("crudCurso",["$resource",function(r){return r("",{},{get:{method:"GET",url:urlEndPoint+"curso/:id",cache:!1,isArray:!1},save:{method:"POST",url:urlEndPoint+"curso",cache:!1,isArray:!1},update:{method:"PUT",url:urlEndPoint+"curso/:id",cache:!1,isArray:!1},delete:{method:"DELETE",url:urlEndPoint+"curso/:id",cache:!1,isArray:!1}})}]),cursoService.factory("listCursosService",["$resource",function(r){return r(urlEndPoint+"curso",{},{get:{method:"GET",cache:!1,isArray:!0}})}]);
"use strict";var professorService=angular.module("professorService",["ngResource"]),resource="professor";professorService.factory("crudProfessor",["$resource",function(r){var e="http://localhost:5000/";return r("",{},{get:{method:"GET",url:e+resource+"/:id",cache:!1,isArray:!1},save:{method:"POST",url:e+resource,cache:!1,isArray:!1},update:{method:"PUT",url:e+resource+"/:id",cache:!1,isArray:!1},delete:{method:"DELETE",url:e+resource+"/:id",cache:!1,isArray:!1}})}]),professorService.factory("listarProfessores",["$resource",function(r){return r(urlEndPoint+resource,{},{get:{method:"GET",cache:!1,isArray:!0}})}]);
"use strict";var semestreService=angular.module("semestreService",["ngResource"]);semestreService.factory("crudSemestre",["$resource",function(e){var r="http://localhost:5000/";return e("",{},{get:{method:"GET",url:r+"semestre/:id",cache:!1,isArray:!1},save:{method:"POST",url:r+"semestre",cache:!1,isArray:!1},update:{method:"PUT",url:r+"semestre/:id",cache:!1,isArray:!1},delete:{method:"DELETE",url:r+"semestre/:id",cache:!1,isArray:!1}})}]),semestreService.factory("listSemestre",["$resource",function(e){return e(urlEndPoint+"semestre",{},{get:{method:"GET",cache:!1,isArray:!0}})}]);