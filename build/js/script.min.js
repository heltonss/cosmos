...
"use strict";var loginControllers=angular.module("loginControllers",[]);loginControllers.controller("loginCtrl",[function(){var l=this;l.title="helton"}]);
"use strict";var appCosmos=angular.module("appCosmos",["ngRoute","loginControllers"]);appCosmos.config(["$routeProvider","$locationProvider",function(o,e){o.when("/",{templateUrl:"partials/user_sessions/login.html",controller:"loginCtrl"}).when("/secretaria",{templateUrl:"partials/dashboard/menu.html",controller:"loginCtrl"}),e.html5Mode({enabled:!1,requireBase:!0}).hashPrefix("!")}]);