...
"use strict";function Professor(t,i,s,e,o,a,h,n,r,c){this.nome=t,this.sobrenome=i,this.dataNascimento=s,this.naturalidade=e,this.sexo=o,this.foto=a,this.endereco=h,this.infoAcademica=n,this.materias=r,this.contato=c,this.getMaterias=function(t){for(var i=[],s=0;s<t.length;s++)i[s]=t[s].tag;this.chips=i}}
...
"use strict";var professorFormControllers=angular.module("professorFormControllers",[]);professorFormControllers.controller("professorFormCtrl",["crudProfessor","$routeParams",function(o,r){function e(){}function a(r){var e=$(".chips").material_chip("data"),a=new Professor;a.nome=r.nome,a.sobrenome=r.sobrenome,a.dataNascimento=r.dataNascimento,a.naturalidade=r.naturalidade,a.sexo=r.sexo,a.foto=r.foto,a.endereco=r.endereco,a.infoAcademica=r.infoAcademica,a.materias=a.getMaterias(e),a.contato=r.contato;var n=JSON.stringify(a,null," ");o.save(n,function(o){console.log("Professor salvo no banco de dados")},function(o){console.log("error"+JSON.stringify(o))})}var n=this;n.create=a,n.update=e}]);
