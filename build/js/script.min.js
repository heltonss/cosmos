...
"use strict";function Professor(t,i,s,e,o,a,h,n,r,c){this.nome=t,this.sobrenome=i,this.dataNascimento=s,this.naturalidade=e,this.sexo=o,this.foto=a,this.endereco=h,this.infoAcademica=n,this.materias=r,this.contato=c,this.getMaterias=function(t){for(var i=[],s=0;s<t.length;s++)i[s]=t[s].tag;return this.chips=i}}
...
"use strict";var professorFormControllers=angular.module("professorFormControllers",[]);professorFormControllers.controller("professorFormCtrl",["crudProfessor","$routeParams",function(o,r){function e(){}function a(r){var e=$(".chips").material_chip("data"),a=new Professor;a.nome=s.sanitizer(r.nome),a.sobrenome=s.sanitizer(r.sobrenome),a.dataNascimento=s.sanitizer(r.dataNascimento),a.naturalidade=s.sanitizer(r.naturalidade),a.sexo=s.sanitizer(r.sexo),a.foto=s.sanitizer(r.foto),a.endereco=s.sanitizer(r.endereco),a.infoAcademica=s.sanitizer(r.infoAcademica),a.materias=a.getMaterias(e),a.contato=s.sanitizer(r.contato);var n=JSON.stringify(a,null," ");o.save(n,function(o){console.log("Professor salvo no banco de dados")},function(o){console.log("error"+JSON.stringify(o))})}var n=this,s=new Sanitizer;n.create=a,n.update=e}]);
