...
"use strict";var alunoFormControllers=angular.module("alunoFormControllers",[]);alunoFormControllers.controller("alunoFormCtrl",["crudAluno","$routeParams",function(o,n){function r(n){var r=r;o.delete({id:r},function(o){location.reload()},function(o){console.log("exclusão deu errado"+JSON.stringify(o))})}function e(r){var e=(n.id,JSON.stringify(r));o.update(e,function(o){console.log("Atualização ocorreu corretamente.")},function(o){console.log("Atualização Falhou")})}function l(n){var n=new Aluno(n.nome,n.sobrenome,n.dataNascimento,n.naturalidade,n.sexo,n.foto,n.nota,n.matricula,n.endereco,n.contato),r=JSON.stringify(n,null," ");o.save(r,function(o){console.log("colaborador salvo no banco")},function(o){console.log("erro"+JSON.stringify(o))})}var a=this;a.exclude=r,a.update=e,a.create=l}]);
