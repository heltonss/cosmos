...
"use strict";var appCosmos=angular.module("appCosmos",["ngRoute","sessionControllers","colaboratorFormControllers"]);appCosmos.config(["$routeProvider","$locationProvider",function(o,r){o.when("/",{templateUrl:"partials/user_sessions/login.html",controller:"sessionCtrl"}).when("/secretaria",{templateUrl:"partials/dashboard/dashboard.html"}).when("/cadastro-colaborador",{templateUrl:"partials/colaborator-form/colaborator-form.html",controller:"colaboratorFormCtrl"}),r.html5Mode({enabled:!0,requireBase:!1}).hashPrefix("!")}]);
"use strict";var colaboratorFormControllers=angular.module("colaboratorFormControllers",[]);colaboratorFormControllers.controller("colaboratorFormCtrl",[function(){}]);
"use strict";var sessionControllers=angular.module("sessionControllers",[]);sessionControllers.controller("sessionCtrl",["$location",function(s){function o(o){s.path("/secretaria")}var n=this;n.sessionValidate=o}]);