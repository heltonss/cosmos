...
"use strict";var sessionControllers=angular.module("sessionControllers",[]);sessionControllers.controller("sessionCtrl",["$location",function(s){function o(o){n.login=o.login,n.pass=o.password,"helton"==n.login&&"123456"==n.pass&&s.path("/secretaria")}var n=this;n.sessionValidate=o}]);
"use strict";var appCosmos=angular.module("appCosmos",["ngRoute","sessionControllers"]);appCosmos.config(["$routeProvider","$locationProvider",function(e,s){e.when("/",{templateUrl:"partials/user_sessions/login.html",controller:"sessionCtrl"}).when("/secretaria",{templateUrl:"partials/dashboard/dashboard.html"}),s.html5Mode({enabled:!0,requireBase:!1}).hashPrefix("!")}]);