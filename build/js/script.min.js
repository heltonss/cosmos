...
"use strict";var cursoControllers=angular.module("cursoControllers",[]);cursoControllers.controller("cursoCtrl",["crudCurso","$routeParams",function(r,o){}]);
...
"use strict";var professorService=angular.module("professorService",["ngResource"]);professorService.factory("crudProfessor",["$resource",function(r){var e="http://localhost:5000/";return r("",{},{get:{method:"GET",url:e+"professor/:id",cache:!1,isArray:!1},save:{method:"POST",url:e+"professor",cache:!1,isArray:!1},update:{method:"PUT",url:e+"professor/:id",cache:!1,isArray:!1},delete:{method:"DELETE",url:e+"professor/:id",cache:!1,isArray:!1}})}]),professorService.factory("listaProfessores",["$resource",function(r){return r(urlEndPoint.toString(),{},{get:{method:"GET",cache:!1,isArray:!0}})}]);
