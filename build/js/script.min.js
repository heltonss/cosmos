...
"use strict";var dashCursoControllers=angular.module("dashCursoControllers",[]);dashCursoControllers.controller("dashCursoCtrl",["$routeParams","crudCurso","listarProfessores","listarAlunos","crudSemestre",function(o,e,n,r,s){function t(o){var e=new Semestre;e.ano=o.ano,e.curso=a.curso.nome,e.semestre=o.semestre.semestre,e.disciplina=a.disciplina,e.professor=o.professor.nome,e.alunosMatriculados=d;var n=JSON.stringify(e,null," ");console.log(n),s.save(n,function(o){console.log("semestre salvo")},function(o){console.log("error",o)})}function i(o){return d.push({nome:o,notas:[]})}function c(o){return d=d.filter(function(e){return e.nome!==o})}function l(){for(var o=document.getElementsByTagName("input"),e=o.length,n=0;n<e;n++)"checkbox"==o[n].type&&o[n].checked&&(a.disciplina=o[n].value)}function u(){for(var o=document.getElementsByTagName("input"),e=o.length,n=0;n<e;n++)"checkbox"!=o[n].type||o[n].checked||(a.disciplina="")}var a=this,f=o.id;a.createSemestre=t,a.addAluno=i,a.removeAluno=c,a.addDisciplina=l,a.removeDisciplina=u;var d=[];e.get({id:f},function(o){a.curso=o},function(o){console.log("error: ",JSON.stringify(o))}),n.get({},function(o){a.professores=o},function(o){console.log("error",JSON.stringify(o))}),r.get({},function(o){a.alunos=o},function(o){console.log("error",JSON.stringify(o))})}]);
